...
# to run:
# source activate tensorflow_p36 && python mc_attack_gan.py 500 5 && python mc_attack_gan.py 500 5 && python mc_attack_gan.py 500 5 && sudo shutdown -P now
...
for exp_no in range(exp_nos):
    ...
    # hog category
    hog_mc_attack_category(trX_inds, vaX_inds, exp_no, 333, 30000, [1,0.1, 0.01])
