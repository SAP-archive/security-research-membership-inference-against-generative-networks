...
#def load_cifar10(directory, percentage=0.1):
#    data_dir = directory
#
...
#
#    train_inds = np.arange(len(dataX))
#    np.random.shuffle(train_inds)
#    dataX = dataX[train_inds]
#    y_vec = y_vec[train_inds]
#
#    n = 60000
...
#
#    print('###########')
#    print(len(dataX[:border]))
#    print('###########')
#
#    return dataX[:border] / 255., y_vec[:border]

def load_cifar10_with_validation(directory, percentage=0.1, reuse=False):
    data_dir = directory
    ...
    return dataX[:border] / 255., y_vec[:border], dataX[border:] / 255., y_vec[border:]
