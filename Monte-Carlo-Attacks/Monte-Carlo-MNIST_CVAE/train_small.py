...
trX = (np.load('trX_vae.npy')*255)
trY = np.load('trY_vae.npy')
...
for epoch in range(n_epochs):
    ...
    if np.mod(epoch, step) == 0:
        ...
        save_visualization(generated_samples, (14,14), save_path='./bb_vis/sample_%04d.jpg' % int(epoch))
        # my change
        saver.save(sess, './bb_models/mnist_gan.ckpt',global_step=epoch)
