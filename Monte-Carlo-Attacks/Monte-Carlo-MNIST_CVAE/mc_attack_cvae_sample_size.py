...
# source activate tensorflow_p36 && python mc_attack_cvae_sample_size.py 299 5 && python mc_attack_cvae_sample_size.py 299 5 && python mc_attack_cvae_sample_size.py 299 5 && python mc_attack_cvae_sample_size.py 299 5 && sudo shutdown -P now
# source activate tensorflow_p36 && python mc_attack_cvae_sample_size.py 299 5 && sudo shutdown -P now
...
def euclidean_PCA_mc_attack_category(n_components_pca, trX_inds, vaX_inds, exp_no, mc_euclidean_no_batches, mc_sample_size, percentiles):
    ...
    for percentile in percentiles:
        ...
        results = calculate_results(distances_trX, distances_vaX, d_min)
...
for exp_no in range(exp_nos):
    ...
    for mc_no_samples in [1, 3, 10, 30, 100, 300]:
        euclidean_PCA_mc_attack_category(40, trX_inds, vaX_inds, exp_no, mc_no_samples, 30000, [10,1,0.1, 0.01, 0.001])
