...
for exp_no in range(exp_nos):
    ...
    euclidean_PCA_mc_attack_category(40, trX_inds, vaX_inds, exp_no, 300, 30000, [1,0.1, 0.01, 0.001])
    print(experiment+': Finished CATEGORY PCA Monte Carlo in experiment %d of %d'%(exp_no+1, exp_nos))

    # hog category (6s per Iteration, )
    # 300
    hog_mc_attack_category(trX_inds, vaX_inds, exp_no, 300, 30000, [1,0.1,0.01, 0.001])
