...
def parse_args():
    ...
    parser.add_argument('--percentage_train_data', type=float, default=0.1, help='How much training data should be used')
...
def main(args):
    ...
    train_total_data, train_size, valid_total_data, validation_size, test_total_data, test_size, test_data, test_labels = mnist_data.prepare_MNIST_data(reuse = False, percentage=args.percentage_train_data)
        ...
        for epoch in range(n_epochs):
            ...
            for i in range(total_batch):
                ...
                _, tot_loss, loss_likelihood, loss_divergence = sess.run(
                    ...
                    feed_dict={x_hat: batch_xs_input, x: batch_xs_target, y: batch_ys_input, keep_prob : args.keep_prob})
